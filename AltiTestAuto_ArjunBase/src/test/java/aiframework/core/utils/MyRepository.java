...
public class MyRepository {
	...
	private static String fileName = "Object_repository.xls";
	...
	public static String getNewLocator(String locator,String attribute)
	{
		MyRepository mr= new MyRepository();
		return mr.getLocator(fileName, "Locators", locator, attribute);
	}
